    ...
    >
      ...
      <div className="relative px-6 py-12 text-center sm:px-10 sm:py-16">
        <motion.p
          ...
          className="font-display text-3xl font-extrabold tracking-tight text-white uppercase sm:text-4xl"
        >
          Tu último año
        </motion.p>
        ...
        <motion.p
          ...
          className="texto-oro -mt-1 font-script text-5xl leading-tight sm:text-6xl"
        >
        ...
        <motion.p
          ...
          className="mt-5 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-sm font-semibold tracking-wide text-white/90 uppercase sm:text-base"
        >
          <span>Viajes</span>
